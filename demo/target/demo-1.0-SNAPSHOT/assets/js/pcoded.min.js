...
$.fn.pcodedmenu = function (settings) {
    ...
    var PcodedMenu = {
        ...
        HandleDropDownIconStyle: function () {
            ...
            switch (settings.themelayout) {
                case 'vertical':
                    $('#' + oid + ' .pcoded-navbar .pcoded-hasmenu').attr("dropdown-icon", "style2");
                    break;
                case 'horizontal':
        ...
        HandleThemeBackground: function () {
            ...
            function setlheadertheme() {
                ...
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .pcoded-header .navbar-logo').attr("logo-theme", "theme6");
                    $('#' + oid + ' .pcoded-navigatio-lavel').attr("menu-title-theme", "theme7");
                } else {
            ...
            function setnavbartheme() {
                ...
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .pcoded-navbar').attr("navbar-theme", "theme2");
                } else {
                    $('#' + oid + ' .pcoded-navbar').attr("navbar-theme", "theme2");
                }
            };
            ...
            function setactiveitemtheme() {
                ...
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .pcoded-navbar').attr("active-item-theme", "theme3");
                } else {
                    $('#' + oid + ' .pcoded-navbar').attr("active-item-theme", "theme3");
                }
            };
